...
def initJobs():
    ...
    for row in res:
        ...
        ctrlConfirm = Button(vrtalkaDList, text='Dodaj', command=ctrlConfirmJob(row[6]), bg='brown', fg='white',
                             font=('Courier New', '18')).grid(column=5, row=i)
        ctrlDelete = Button(vrtalkaDList, text='Dodaj', command=ctrlDeleteJob(row[6]), bg='brown', fg='white',
